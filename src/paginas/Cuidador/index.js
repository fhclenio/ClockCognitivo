...
import { ConsultarInformacoesDoUsuarioAtual, ConsultarPacienteComCuidador, ConsultarPacientesDoCuidador } from "../../servicos/requisicoesFirebase.js";
        ...
        const carregarPacientes = async () => {
            ...
            pacientes.forEach((doc) => {
                const carregarPaciente = async () => {
                    ...
                    setListaDePacientes(arrayAntigo => [...arrayAntigo, (
