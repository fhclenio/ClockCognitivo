...
export default function Medicamento({ route }) {
    ...
    async function salvar() {
        ...
        let uid = (route && route.params && route.params.uid) ? route.params.uid : auth.currentUser.uid;
        ...
        if (medicamento)
            agendarNovoAlarme(nome, descricao, dias, horario);
                ...
                <View style={styles.card}>
                    ...
                    <ScrollView style={styles.scroll}>
                        ...
                        <View style={styles.containerInput}>
                            ...
                            <View style={styles.inputbody}>
                                <TextInput style={styles.input} value={medico}
                                        onChangeText={(valor) => setMedico(valor)}/>
                            </View>
                        </View>
                        <View style={styles.containerInput}>
                            <View style={styles.inputHeader}>
